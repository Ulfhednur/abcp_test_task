...
/**
 * Код предназначен для уведомления клиента и сотрудников при изменении статуса некой жалобы. И отдачи результата
 * попытки уведомления для дальнейшей обработки. Записи в лог? Сохранения в отчёт? Включения сирены боевой тревоги
 * в казарме с оперативниками?
 * Кто такие автор и клиент, и кто из них на кого пожаловался - не очень понятно.
 * Качество кода. Изначально: КГ/АМ, но тут понятно, для чего это сделано :-)
 * Сейчас: на четвёрочку. Что бы сделать лучше, надо понимать: кто на кого пожаловался; куда выезжать оперативникам;
 * какая структура таблиц у базы, откуда всё это брать; какой паттерн используется для приложения в целом; и т.д.
 *
 *
